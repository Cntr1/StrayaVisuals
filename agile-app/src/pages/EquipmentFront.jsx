...
const EquipmentFront = () => {
  ...
  return (
      <div className="content-container">
        <nav className="nav-contact">
          <ul>
            ...
            <div className="nav-center">
              ...
              <li><Link to="/equipment" id="selected">Equipment</Link></li>
        ...
        <div className="content-box" style={{marginTop:"0px", marginRight:"auto", marginLeft:"auto", paddingRight:"50px", paddingLeft:"50px", width:"100%"}}>
        ...
        <div className="equipment-gallery" >
          ...
          <div className="gallery-container" style={{width:"95%", marginRight:"auto", marginLeft:"auto"}}>
