  ...
  useEffect(() => {
    const fetchInitialData = async () => {
      try {
        ...
        const sortedPackages = packageOrder.map(id => packagesList.find(pkg => pkg.id === id)).filter(Boolean);
        ...
        const socialsData = socialsSnapshot.docs.map(doc => ({ originalId: doc.id, ...doc.data() }));
            ...
            <div className="app-container">
              ...
              <div className="content-container">
                <Routes>
                  ...
                  <Route path="/contact" element={<Contact packages={packagesData} socials={socials} />} />
