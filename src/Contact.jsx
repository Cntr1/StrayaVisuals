...
const Contact = () => {
  ...
  const changeVideo = useCallback(
    (index, direction, resetTimer = true) => {
      setIsFading(true);
      setTimeout(() => {
  ...
  useEffect(() => {
    ...
    const ratesObserver = new IntersectionObserver(
      (entries, observer) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
  ...
  return (
    <div style={{ marginTop: "-50px" }}>
      ...
      <div
        ...
        className="container"
        style={{ marginTop: "45px", minWidth: "1440px" }}
      >
      ...
      <div className="cta-container-contact">
        ...
        <div className="cta-text-contact">
          Any Questions? Feel free to ask us below, our team will get in touch
      ...
      <section className="contact-form-section-contact">
        <form className="contact-form-contact" onSubmit={handleSubmit}>
          ...
          >
            ...
            <option value="About a Custom Video Request">
              About a Custom Video Request
            </option>
          ...
          {inquiryType === "other" && (
            <div id="other-inquiry-type-container">
              ...
              <input
                type="text"
                id="other-inquiry-type"
                name="other-inquiry-type"
                placeholder="Please briefly specify the purpose of your inquiry"
                value={otherInquiryType}
          ...
          <label htmlFor="inquiry-details" style={{ marginTop: "20px" }}>
          ...
          socials.map((social, index) => (
            ...
            >
              ...
              <div className="social-content-contact">
                <img
                  className="landscape-image-contact"
                  src={social.cover}
                  alt={`${social.platform} Cover`}
                />
                <img
