  ...
  return (
    <div className="hero-section">
      ...
      >
        ...
        <Button variant="outline-light" className="hero-button">Discover Our Work</Button>
      </motion.div>
  ...
  const sections = [
    {
      ...
      content: "Welcome to STRAYA VISUALS.... The Creative hub for high-quality videography and content creation! ...",
      image: "../assets/im1.png",
      category: "about"
    },
    {
      title: "With Breathtaking Bird's Eye View Captures",
      content: "With a deep passion for storytelling and cutting-edge video techniques, ...",
      image: "../assets/im2.jpg",
      category: "drone"
    },
    {
      title: "Working on FPV Build",
      content: "Over the past few weeks, I’ve been working on my first FPV build ...",
      video: "../assets/v2.mp4",
      category: "fpv"
    },
    {
    ...
    <div className="portfolio-container">
              ...
              >
                ...
                >
                  <div className="card-media">
                    {section.image && <img src={section.image} alt={section.title} className="card-image" />}
                    {section.video && (
                      <video className="card-video" loop muted autoPlay playsInline>
                  ...
                  <div className="card-content">
                    <h3>{section.title}</h3>
                    <p className={activeCard === index ? "expanded" : ""}>{section.content}</p>
      ...
      <div className="cta-section">
        ...
        >
          ...
          <Button variant="glow" size="lg" className="cta-button">Start Your Project</Button>
        </motion.div>
      </div>
    </div>
  );
