  ...
  return (
    ...
    <div className="min-vh-100">
      ...
      <div
        ...
        style={{ background: "linear-gradient(to right, #e9ab40, #ccb089)" }}
      >
        <div className="container">
          <h2 className="fw-bold text-center mb-4">CLIENT REVIEWS</h2>
          <div
            id="clientReviewsCarousel"
          ...
          >
            <div className="carousel-inner">
              ...
              <div className="carousel-item active">
                <div
                  className="bg-white p-4 rounded-4 shadow-sm text-center mx-auto"
                  style={{ maxWidth: "800px" }}
                >
                  <p className="fst-italic fs-5">
                    "Slinky were very professional, on-time, knowledgeable and
                    worked hard to make sure the production was a success."
                  </p>
              ...
              <div className="carousel-item">
                ...
                >
                  <p className="fst-italic fs-5">
                    "Amazing work! The team was very creative and delivered
              ...
              <div className="carousel-item">
                ...
                >
                  <p className="fst-italic fs-5">
                    "Highly recommend StrayaVisuals for their professionalism
